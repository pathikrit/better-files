...
Auto-closed instances also have a useful method to generate [self-closing iterators](core/src/main/scala/better/files/CloseableIterator.scala) that auto close the parent resource on exhaustion:
```scala
